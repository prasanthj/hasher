 ...
 * Java port of https://code.google.com/p/smhasher/source/browse/trunk/MurmurHash3.cpp#255
 */
public class Murmur3_128 {
   ...
   * @return - hashcode (2 longs)
   */
  public static long[] hash(byte[] data, int length, int seed) {
    long h1 = seed;
    long h2 = seed;
